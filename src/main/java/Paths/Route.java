...
public enum Route {
    ...
    // --- AUTH ---
    AUTH_LOGIN("Login Form", HttpMethod.GET, BasePaths.AUTH + "/login"),
    AUTH_LOGIN_POST("Login", HttpMethod.POST, BasePaths.AUTH + "/login"),
    AUTH_REGISTER("Register Form", HttpMethod.GET, BasePaths.AUTH + "/register"),
    AUTH_REGISTER_POST("Register", HttpMethod.POST, BasePaths.AUTH + "/register"),
    AUTH_LOGOUT("Logout", HttpMethod.GET, BasePaths.AUTH + "/logout"),
    // --- USERS ---
    ...
    CATEGORIES_CREATE("Create Category", HttpMethod.POST, BasePaths.CATEGORIES + "/create"),
    CATEGORIES_CREATE_FORM(
            "Create Category Form",
            HttpMethod.GET,
            BasePaths.CATEGORIES + "/create"
    ),
